...
pub struct Args {
    #[clap(long, default_value="off", about=r#"Allowed values: "off", "Error", "Warn", "Info", "Debug", "Trace""#)]
    log_level: LevelFilter,
    #[clap(long, about="log file location")]
    log_file: Option<String>,
    #[clap(short, long, default_value="250", about="Time between refresh in ms")]
    refresh_rate: u64,
    #[clap(short, long, default_value="30", about="Maximum length a single notification can use in chars")]
    max_text_length: usize,
    #[clap(short, long, default_value="5", about="How fast the text is animated")]
